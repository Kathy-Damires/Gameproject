...
namespace ProjectEvolvion
{
    public class SaveSystem : MonoBehaviour
    {
        ...
        private PlayerState CreateNewGame()
        {
            ...
            // Doresa and Aitherium locked
            state.planets.Add(new PlanetState { planetId = "doresa", isUnlocked = false });
            state.planets.Add(new PlanetState { planetId = "aitherium", isUnlocked = false });
