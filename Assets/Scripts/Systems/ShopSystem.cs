    ...
    public class ShopSystem : MonoBehaviour
    {
        ...
        public List<object> OpenChest(string chestItemId)
        {
            ...
            for (int i = 0; i < numItems; i++)
            {
                ...
                {
                    // Resources
                    var resPlanet = _state.GetActivePlanet();
                    int eraBonus = resPlanet != null ? (int)resPlanet.currentEra + 1 : 1;
                    int amount = Random.Range(50, 200) * eraBonus;
        ...
        public bool ClaimVIPDailyReward()
        {
            ...
            var vipPlanet = _state.GetActivePlanet();
            int eraMultiplier = vipPlanet != null ? (int)vipPlanet.currentEra + 1 : 1;
